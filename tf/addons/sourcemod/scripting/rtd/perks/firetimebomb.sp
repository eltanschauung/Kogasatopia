...
public void FireTimebomb_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		FireTimebomb_ApplyPerk(client, perk);
	}
	else
	{
		FireTimebomb_RemovePerk(client, reason);
	}
}
