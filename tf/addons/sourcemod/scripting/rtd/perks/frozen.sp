...
public void Frozen_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		Frozen_ApplyPerk(client, perk);
	}
	else
	{
		Frozen_RemovePerk(client, reason);
	}
}
