...
public void PowerPlay_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		PowerPlay_ApplyPerk(client, perk);
	}
	else
	{
		PowerPlay_RemovePerk(client, reason);
	}
}
