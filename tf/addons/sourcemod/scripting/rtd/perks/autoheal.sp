...
public void Autoheal_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		Autoheal_ApplyPerk(client, perk);
	}
	else
	{
		Autoheal_RemovePerk(client, reason);
	}
}
