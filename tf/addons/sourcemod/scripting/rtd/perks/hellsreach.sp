...
public void HellsReach_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		HellsReach_ApplyPerk(client, perk);
	}
	else
	{
		HellsReach_RemovePerk(client, reason);
	}
}
