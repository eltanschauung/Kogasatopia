...
public void EldenStars_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		EldenStars_ApplyPerk(client, perk);
	}
	else
	{
		EldenStars_RemovePerk(client, reason);
	}
}
