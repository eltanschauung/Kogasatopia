...
public void Smite_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		Smite_ApplyPerk(client, perk);
	}
	else
	{
		Smite_RemovePerk(client, reason);
	}
}
