...
public void Timebomb_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		Timebomb_ApplyPerk(client, perk);
	}
	else
	{
		Timebomb_RemovePerk(client, reason);
	}
}
