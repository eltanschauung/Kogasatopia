...
public void SpringShoes_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		SpringShoes_ApplyPerk(client, perk);
	}
	else
	{
		SpringShoes_RemovePerk(client, reason);
	}
}
