...
public void TeamCriticals_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		TeamCriticals_ApplyPerk(client, perk);
	}
	else
	{
		TeamCriticals_RemovePerk(client, reason);
	}
}
