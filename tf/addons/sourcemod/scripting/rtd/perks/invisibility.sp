...
public void Invisibility_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		Invisibility_ApplyPerk(client, perk);
	}
	else
	{
		Invisibility_RemovePerk(client, reason);
	}
}
